...
4. `docs/repo/status/CODEX_CURRENT_STATUS.md` — короткий текущий dev-status; `docs/repo/status/CODEX_STATUS.md` — подробный журнал Codex.
...
Default reading model: Current Memory first, Knowledge by task, History only for evidence/regression/archaeology.
