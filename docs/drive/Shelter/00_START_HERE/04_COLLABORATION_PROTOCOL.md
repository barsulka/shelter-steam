...
Открой через локальный файлсервер указанный Cross-role RFC-документ.
...
Прочитай его context/sources и релевантные repo docs: PROJECTS_RULES.md, AGENTS.md, README.md, docs/repo/status/CODEX_STATUS.md, role Codex и product contracts.
