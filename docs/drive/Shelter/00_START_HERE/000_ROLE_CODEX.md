...
- читать `PROJECTS_RULES.md`, `AGENTS.md`, `README.md`, `docs/`, `docs/repo/status/CODEX_STATUS.md`;
...
- обновлять `docs/repo/status/CODEX_STATUS.md` после значимой dev-задачи;
...
Implementation roadmap/status для Codex — живой рабочий план, а не product decision. Существенные изменения последовательности dev-задач нужно обосновывать и фиксировать в `docs/repo/status/CODEX_STATUS.md`, handoff или отдельном dev/update документе.
