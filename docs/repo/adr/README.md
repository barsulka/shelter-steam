...
| [0004: Godot Child Observability And Graceful Termination](0004-godot-child-observability-and-graceful-termination.md) | Accepted | Godot subprocess preflight, raw diagnostics, child/result separation, graceful stop and nonfatal recovery proof | Read before adding or changing any project-owned Godot launcher, wrapper, test/capture runner, process monitor, timeout/termination path or process-restart recovery evidence. |
